...
class UIFunctions(MainWindow):
    ...
    def check_cam_angles(self):
        ...
        for cam_id, (button, led_id) in sim_buttons.items():
    ...
    def refresh_estrella1_list(self):
        ...
        for item in estrella1:
            ...
            if numeric_code in clip_data:
                ...
                clip_info = f"{item[:4]},   {name},   {pl},   {tc_in},   {tc_out},   {dur}"
    ...
    def export_clip():
        ...
        endpoint_6 = "api/?Function=ReplayDeleteSelectedEvent&Value=19&Channel=1"
        ...
        try:
            ...
            if preset_tag is not None:
                ...
                UIFunctions.send_request(endpoint_1)
                time.sleep(0.2)
                UIFunctions.send_request(endpoint_6)
                time.sleep(0.2)
                UIFunctions.send_request(endpoint_5)
                time.sleep(0.2)
                UIFunctions.send_request(endpoint_1)
        ...
        def on_dial_moved(value):
            ...
            if getattr(self, "browse_mode", False):  # Verifica si estamos en browse_mode
                ...
                if hasattr(self.ui, list_name):  # Verifica si la lista existe en la UI
                    ...
                    # Comprobar si el nuevo índice está dentro de los límites
                    ...
                    if direction == 1:
                        ...
                        UIFunctions.send_request("api/?Function=ReplaySelectPreviousEvent&Channel=1")
